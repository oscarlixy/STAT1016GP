...
# Output directory
OUTPUT_DIR = '/Users/oscar/Downloads/t_test_analysis'
...
# Read cleaned data
df = pd.read_csv('/Users/oscar/Downloads/cleaned_ai_job_data.csv')
...
results_text = f"""
================================================================================
Independent Samples T-Test Results Report
================================================================================
...
results_path = os.path.join(OUTPUT_DIR, 'ttest_results.txt')
