"""
EDA Visualization for AI Job Market Salary Analysis - Version 2
- Correlation Heatmap
...
VIS_DIR = os.path.join(VERSION2_DIR, 'visualization')
...
# Save figure
boxplot_path = os.path.join(VIS_DIR, 'boxplot_salary_comparison.png')
...
# ============================================================
print("\n" + "="*60)
print("SUMMARY STATISTICS (Version 2)")
print("="*60)
...
print(f"\nAI Skill Requirement percentage:")
print(f"  AI Required (1): {df['AI_Skill_Requirement'].mean()*100:.1f}%")
print(f"  Non-AI (0): {(1-df['AI_Skill_Requirement'].mean())*100:.1f}%")
